...
public final class AudioHelper {
    ...
    public static var inputDevices: [AHAudioDevice] { getDeviceList(for: .input) }
    public static var inputDeviceNames: [String] { inputDevices.map { $0.name! } }
    
    public static var outputDevices: [AHAudioDevice] { getDeviceList(for: .output) }
    public static var outputDeviceNames: [String] { outputDevices.map { $0.name! } }
...
public struct AHAudioDevice {
    ...
    public var isDefault: Bool { isDefaultDevice() }
